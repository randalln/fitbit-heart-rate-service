...
1. A Fitbit Sense or Versa 3 smart watch and a device running at least Android 9.0 (Pie) or iOS 15.6
...
3. Install the mobile app
   #### Android
     * Install Virtual Heart Rate Monitor from Google Play (Android)
   #### iOS
   ...
   3. Install Virtual Heart Rate Monitor
